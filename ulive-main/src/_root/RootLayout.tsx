    ...
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      <Parent>
        <main className="grid grid-cols-12 w-full">
          <div
            className={`${
              size === false ? "col-span-1" : "col-span-2"
            }  hidden lg:block md:block border`}
          >
            <span
              onClick={goToHome}
              className="!pl-4 cursor-pointer py-4 inline-block"
            >
              <svg
              ...
              >
                <g fill="#1791cf">
                  ...
                  />
                  <path d="M121.14 112.57v-3.242h-1.214v-.434h2.93v.434h-1.223v3.242zm2.223 0v-3.676h.735l.875 2.602c.082.242.14.426.175.543q.065-.2.2-.586l.882-2.559h.66v3.676h-.472v-3.078l-1.074 3.078h-.442l-1.066-3.129v3.129z" />
                </g>
              </svg>
            </span>
